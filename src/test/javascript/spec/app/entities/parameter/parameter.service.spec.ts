...
import { IParameter, Parameter, Unit } from 'app/shared/model/parameter.model';
...
describe('Service Tests', () => {
    describe('Parameter Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ParameterService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Parameter(0, 0, 0, 0, Unit.Kg, 'AAAAAAA');
        });
